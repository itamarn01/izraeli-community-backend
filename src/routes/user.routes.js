...
router.post('/me/spouse-email', ctrl.requestSpouseEmail);
router.post('/me/spouse-email/verify', ctrl.verifySpouseEmail);
router.delete('/me/spouse-email', ctrl.removeSpouseEmail);
